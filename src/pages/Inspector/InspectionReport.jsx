    ...
    if (inspData) {
      setFormData({
        ...
        manufacturingDate: inspData.object.manufacturingDate
          ? inspData.object.manufacturingDate.split("T")[0]
          : "",
        registrationDate: inspData.object.registrationDate
          ? inspData.object.registrationDate.split("T")[0]
          : "",
        rto: inspData.object.rto,
        fitnessUpto: inspData.object.fitnessUpto
          ? inspData.object.fitnessUpto.split("T")[0]
          : "",
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={6}>
            <FormControl fullWidth required error={!!errors.rcAvailability}>
              ...
              {errors.rcAvailability && (
                <FormHelperText>{errors.rcAvailability}</FormHelperText>
              )}
            </FormControl>
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            <FormControl fullWidth required error={!!errors.mismatchInRC}>
              ...
              {errors.mismatchInRC && (
                <FormHelperText>{errors.mismatchInRC}</FormHelperText>
              )}
            </FormControl>
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            <FormControl fullWidth required error={!!errors.rtoNocIssued}>
              ...
              {errors.rtoNocIssued && (
                <FormHelperText>{errors.rtoNocIssued}</FormHelperText>
              )}
            </FormControl>
          </Grid>
          {/* NOC Issued */}
          ...
          <Grid item xs={12} sm={6}>
            <FormControl fullWidth required error={!!errors.noClaimBonus}>
              ...
              {errors.noClaimBonus && (
                <FormHelperText>{errors.noClaimBonus}</FormHelperText>
              )}
            </FormControl>
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            <FormControl fullWidth required error={!!errors.underHypothecation}>
              ...
              {errors.underHypothecation && (
                <FormHelperText>{errors.underHypothecation}</FormHelperText>
              )}
            </FormControl>
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            <FormControl fullWidth required error={!!errors.roadTaxPaid}>
              ...
              {errors.roadTaxPaid && (
                <FormHelperText>{errors.roadTaxPaid}</FormHelperText>
              )}
            </FormControl>
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            <FormControl fullWidth required error={!!errors.partipeshiRequest}>
              ...
              {errors.partipeshiRequest && (
                <FormHelperText>{errors.partipeshiRequest}</FormHelperText>
              )}
            </FormControl>
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            <FormControl fullWidth required error={!!errors.duplicateKey}>
              ...
              {errors.duplicateKey && (
                <FormHelperText>{errors.duplicateKey}</FormHelperText>
              )}
            </FormControl>
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            <FormControl
              fullWidth
              required
              error={!!errors.chassisNumberEmbossing}
            >
              ...
              {errors.chassisNumberEmbossing && (
                <FormHelperText>{errors.chassisNumberEmbossing}</FormHelperText>
              )}
            </FormControl>
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            <FormControl fullWidth required error={!!errors.cngLpgFitmentInRC}>
              ...
              {errors.cngLpgFitmentInRC && (
                <FormHelperText>{errors.cngLpgFitmentInRC}</FormHelperText>
              )}
            </FormControl>
          </Grid>
        </Grid>
